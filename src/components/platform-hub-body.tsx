...
import { formatAPY, formatAPYProse, formatTVL } from "@/lib/format";
          ...
          <div className="uni-hub-content-grid">
            <article>
              ...
              <p>
                ...
                {formatAPYProse(minApy)} to {formatAPYProse(bestApy)}. Median{" "}
                {formatAPYProse(medianApy)}, mean {formatAPYProse(avgApy)}. Numbers are
