  ...
  return (
    <main className="page">
      ...
      <section className="hero">
        <div>
          <h1>
            ...
            <span className="dim">
              {vaults.length > 0
                ? `Compare ${vaults.length} USDC strategies we monitor, ranked by APY across ${chainCount} chain${chainCount !== 1 ? "s" : ""}.`
        ...
        <div className="hero-right">
          <div className="stat-tile">
            <div className="stat-label">Total USDC TVL</div>
      ...
      {vaults.length > 0 ? (
        ...
        >
          <p style={{ margin: 0 }}>No USDC vaults indexed yet.</p>
